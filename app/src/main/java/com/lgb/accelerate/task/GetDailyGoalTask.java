 ...
 * 
 */
public class GetDailyGoalTask extends AsyncTask<Map<String, Object>, Object, String> {
	...
	protected String doInBackground(Map<String, Object>... params) {
		...
		result = httpBaseUtil.postData(Constant.URL_GET_GOAL, paramsMap);
		return result;
	}
	...
	protected void onPostExecute(String result) { // onPostExecute方法用于在执行完后台任务后更新UI,显示结果
		...
		msg.what = Constant.HANDLER_GET_DAILY_GOAL_RESULT;
		msg.obj = result;
