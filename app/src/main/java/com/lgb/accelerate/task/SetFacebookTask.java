 ...
 * 
 */
public class SetFacebookTask extends AsyncTask<Map<String, Object>, Object, String> {
	...
	protected String doInBackground(Map<String, Object>... params) {
		...
		String fb_id = (String) params[0].get(Constant.KEY_FACEBOOK_ID);

		// 参数map
		Map<String, String> paramsMap = new HashMap<String, String>();

		paramsMap.put(Constant.KEY_UID, String.valueOf(id));
		paramsMap.put(Constant.KEY_FACEBOOK_ID, fb_id);

		// 提交
		HttpBaseUtil httpBaseUtil = new HttpBaseUtil();
		result = httpBaseUtil.postData(Constant.URL_SET_FACEBOOK, paramsMap);
	...
	protected void onPostExecute(String result) { // onPostExecute方法用于在执行完后台任务后更新UI,显示结果
		...
		msg.what = Constant.HANDLER_SET_FACEBOOK_RESULT;
		msg.obj = result;
